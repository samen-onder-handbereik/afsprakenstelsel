...
Van:
![Alt text]({{ site.baseurl }}/assets/before.png)

Naar:
![Alt text]({{ site.baseurl }}/assets/after.png)
...
Alle hierboven genoemde contextattributen vormen de minimale metadataset die 
CloudEvents definieert. 
...
[1]: https://gitdocumentatie.logius.nl/publicatie/notificatieservices/CloudEvents-NL/